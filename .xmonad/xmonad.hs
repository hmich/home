...
--
myWorkspaces    = ["work", "web", "irssi", "emacs", "system", "other"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    -- launch dmenu
    , ((modMask,               xK_p     ), spawn "exe=`dmenu_path | dmenu -nb black -nf white -fn ` && eval \"exec $exe\"")
...
myLayout = onWorkspace "system" (Mirror tiled) $
           simpleTabbed ||| tiled ||| Mirror tiled ||| Full
  where
...
myManageHook = composeAll
    ...
    , resource  =? "irssi"          --> doF (W.shift "irssi") ]
